...
#2. 모델구성
model = Sequential()
model.add(LSTM(50, input_shape=(9, 1), activation='relu'))
...
# model.save(path +"keras39_dropout04_save_model.hdf5")
...
submission.to_csv(path + 'submission_01120706.csv')
