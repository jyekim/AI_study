...
dense1 = LSTM(11, activation='relu', name='ds11')(input1)
dense2 = Dense(12, activation='relu', name='ds12')(dense1)
dense3 = Dense(13, activation='relu', name='ds13')(dense2)
output1 = Dense(14, activation='relu', name='ds14')(dense3)
#2-2 모델 2
input2 = Input(shape=(5, 5))
dense21 = LSTM(21, activation='linear', name='ds21')(input2)
...
loss :  13722762.0
mse :  13722762.0
종가 :  [154500.] / 예측가 :  [154995.64]
종가 :  [184500.] / 예측가 :  [182674.38]
종가 :  [234000.] / 예측가 :  [228511.22]
종가 :  [277000.] / 예측가 :  [283560.62]
종가 :  [173000.] / 예측가 :  [175032.8]
