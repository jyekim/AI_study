...
dense2 = Dense(250, activation='relu', name='ds12')(dense1)
dense3 = Dense(430, activation='relu', name='ds13')(dense2)
output1 = Dense(150, activation='relu', name='ds14')(dense3)
#2-2 모델 2
input2 = Input(shape=(5, 5))
dense21 = LSTM(100, activation='linear', name='ds21')(input2)
dense22 = Dense(90, activation='linear', name='ds22')(dense21)
output2 = Dense(85, activation='linear', name='ds23')(dense22)
#2-3 모델병합
from tensorflow.keras.layers import concatenate
merge1 = concatenate([output1, output2], name ='mg1')
merge2 = Dense(200, activation= 'relu', name ='mg2')(merge1)
merge3 = Dense(130, name ='mg3')(merge2)
...
model.fit([x_train_scaled, x2_train_scaled], y_train, validation_split=0.2, 
          verbose=1, batch_size=10, epochs=100, 
...
print('시가 : ', y_test[-1], '/ 예측가 :', y1_pred[-1])
