...
# x_test = scaler.transform(x_test)
 ...
 #2.모델구성(순차형)
model = Sequential()
model.add(LSTM(100, input_shape=(8, 1), activation='relu'))
model.add(Flatten())
...
결과
LSTM : RMSE :  0.6941494884219312
R2스코어:  0.6355989652465841


cnn 값
loss :  0.4326864182949066
RMSE :  0.6410780342616464
R2스코어:  0.6891897169610948
